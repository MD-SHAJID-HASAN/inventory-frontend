...
function SidebarU({ collapsed, onPageChange, currentPage, onToggle}: any) {
  ...
  return (
    <div
      className={`${
        collapsed ? "w-20 " : "w-72"
      } transition-all duration-300 ease-in-out bg-white/80 dark:bg-slate-900/80 backdrop-blur-xl border-r border-slate-200/50 dark:border-slate-700/50 flex flex-col relative z-10 min-h-screen`}
    >
      {/* logo */}
      <div
        className={`${
      ...
      >
        <div className="flex items-center space-x-3">
          <div
            ...
            } min-w-10 h-10 bg-gradient-to-r from-blue-600 to bg-purple-600 rounded-xl flex items-center justify-center`}
          >
          ...
          <div
            ...
            } transition-all duration-300 ease-in-out text-xl font-bold text-slate-800 dark:text-white`}
          >
            <h1>Ledgerly</h1>
      ...
      <div className=" p-4 border-t border-slate-200/50 dark:border-slate-700/50">
        <div
          className={`min-w-10 flex items-center justify-center space-x-3 p-3 rounded-xl bg-slate-50 dark:bg-slate-800/50`}
        >
          <img
            src=""
            alt=""
          ...
          {/* conditional rendering */}
          <div
            className={`{!collapsed ? 'flex' : 'hidden'}flex flex-1 min-w-0`}
          >
