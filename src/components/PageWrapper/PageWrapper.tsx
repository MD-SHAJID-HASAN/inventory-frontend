    ...
    <div>
      <div className="flex justify-between">
        <button
          ...
          className="flex items-center space-x-2 py-2 px-4 my-3 bg-gradient-to-r to-blue-500 from-purple-600 text-white rounded-xl hover:shadow-lg transition-all cursor-pointer"
        >
