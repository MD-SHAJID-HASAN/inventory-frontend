...
function ShopList() {
  ...
  return (
    <PageWrapper btnText="New Shop" href="/shop-form" pageTitle="Your Shops">
      <div className="flex flex-wrap gap-3">
        ...
        <div className="hidden flex-col gap-3 ">
          <Link
            to={"/add-product-form"}
            className=" hidden lg:flex items-center space-x-2 py-2 px-4 bg-gradient-to-r from-blue-500 to-purple-600 text-white rounded-xl hover:shadow-lg transition-a cursor-pointer"
          >
